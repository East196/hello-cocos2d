...
class Hero:
    ...
    def action(self, event):
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            position = pygame.mouse.get_pos()
            self.acc[1] += 1
            self.arrows.append([math.atan2(position[1] - (self.playerpos1[1] + 32), position[0] - (self.playerpos1[0] + 26)), self.playerpos1[0] + 12,
                                self.playerpos1[1] + 52])
            self.arrows.append([math.atan2(position[1] - (self.playerpos1[1] + 32), position[0] - (self.playerpos1[0] + 26)), self.playerpos1[0] + 32,
                                self.playerpos1[1] + 32])
            self.arrows.append([math.atan2(position[1] - (self.playerpos1[1] + 32), position[0] - (self.playerpos1[0] + 26)), self.playerpos1[0] + 52,
                                self.playerpos1[1] + 12])
            if len(self.game.badguy.badguys):
                target = self.game.badguy.badguys[0]
                self.arrows.append([math.atan2(target[1] - (self.playerpos1[1] + 32), target[0] - (self.playerpos1[0] + 26)) - 0.1, self.playerpos1[0] + 32,
                                    self.playerpos1[1] + 32])
                self.arrows.append([math.atan2(target[1] - (self.playerpos1[1] + 32), target[0] - (self.playerpos1[0] + 26)) - 0.2, self.playerpos1[0] + 32,
                                    self.playerpos1[1] + 32])
                self.arrows.append([math.atan2(target[1] - (self.playerpos1[1] + 32), target[0] - (self.playerpos1[0] + 26)) - 0.3, self.playerpos1[0] + 32,
                                    self.playerpos1[1] + 32])
...
class Clock():
    ...
    def display(self):
        survivedtext = self.font.render(str((90000 - pygame.time.get_ticks()) / 60000) + ":" + str((90000 - pygame.time.get_ticks()) / 1000 % 60).zfill(2),
                                        True, (0, 0, 0))
